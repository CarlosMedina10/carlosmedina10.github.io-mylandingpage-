...
import 'package:EntrenaAPP/Pages/SendEmail.dart';
...
import 'package:EntrenaAPP/NavigationBar/NavigationBar.dart';
import 'package:EntrenaAPP/Pages/LandingPage.dart';
import 'package:EntrenaAPP/Pages/ConocenosPage.dart';
          ...
          if (state is IsMobileOrTablet)
{
  print('este estadoooo');
          return Scaffold(body: Drawer3d(state.isOnPrincipal,state.isOnConocenos));
}
...
class Drawer3d extends StatefulWidget {
 final  bool isOnPrincipal;
  ...
  Drawer3d(this.isOnPrincipal,this.isOnConocenos);
  @override
      ...
      builder: (context, id) { 
       if  (id== 0) 
        ...
        children:  [
          ...
          LandingPage(true),ConocenosPage(false),SendEmail(false)] 
        ...
        children:  [
          ...
          LandingPage(false),ConocenosPage(true),SendEmail(false)] 
        ...
        children:  [
          ...
          LandingPage(false),ConocenosPage(false),SendEmail(true)] 
