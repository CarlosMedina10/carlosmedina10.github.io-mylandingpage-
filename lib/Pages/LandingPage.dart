       ...
       if (isMobile || isTablet)
            {
              BlocProvider.of<LandingpageBloc>(
                                                                          context)
                                                                      .add(WantMobileOrTablet(true,false,false));
            }
            if (!isMobile && !isTablet && widget.isOnPrincipal)
            {
     BlocProvider.of<LandingpageBloc>(
                                                                          context)
                                                                      .add(WantIsDesktop(true, false, false));
            }
            ...
            Container(
                ...
                height: (size.height>500) ? size.height*3/8 : 200,
                    ...
                    child: Padding(
                      ...
                      child: Image(
                        image: AssetImage("images/DiseñoFondo2.png"),
                      ),
                    ),
                  ) : Container(),
            Container(
              height: (isMobile) ? (size.height>500) ? size.height*5/8 : 300 : (size.height>500) ? size.height : 500,
              width: size.width,
               ...
               (!isMobile) ?
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: Image(
                        image: (isTablet) ?  AssetImage("images/DiseñoFondo.png") : AssetImage("images/DiseñoFondo2.png"),
                      ),
                    ),
                  ) : Container(), 
                ],
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(
                            ...
                            style:  TextStyle(
    color: Color(0xff0A183D),
    fontSize: (isMobile) ? 12 : (isTablet) ? 14 : 17.0, 
                            ...
                            child: Wrap(
                              children: [
                                Text(
                                  ...
                                  style: TextStyle(
    color: Colors.white,
    fontSize: (isMobile) ? size.width/25 : (isTablet) ? size.width/35 : size.width/30,   
    fontWeight: FontWeight.w600,
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
    color: Color(0xff0A183D),
    fontSize: (isMobile) ? size.width/15 : (isTablet) ? size.width/20 :  size.width/25,   
    fontWeight: FontWeight.w600,
    letterSpacing: 0.75,
  ),
